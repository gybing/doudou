...
public class DoudouHttpClient {
    private static final String CHARSET = HTTP.UTF_8;
    private static HttpClient customerHttpClient;
    private static final String TAG = "DoudouHttpClient";
    private static String doudouTicket = ""; 
    
    private DoudouHttpClient() {
    }
    ...
    public static synchronized HttpClient getHttpClient() {
        if (null == customerHttpClient) {
            ...
            HttpProtocolParams.setUserAgent(params,"Mozilla/5.0(Linux;U;Android 2.3.1;en-us;Nexus One Build.FRG83) "
