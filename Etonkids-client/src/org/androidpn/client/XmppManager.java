...
public class XmppManager {
    ...
    private static final String XMPP_RESOURCE_NAME = "iTeach -- Client";
                    ...
                    public void processPacket(Packet packet) {
                        ...
                        if (packet instanceof IQ) {
                            ...
                            if (response.getType() == IQ.Type.ERROR) {
                                ...
                                Log.d(LOGTAG, "APN username=" + newUsername);
                                Log.d(LOGTAG, "APN password=" + newPassword);
    ...
    private class LoginTask implements Runnable {
        ...
        public void run() {
            ...
            if (!xmppManager.isAuthenticated()) {
                Log.d(LOGTAG, "APN username=" + username);
                Log.d(LOGTAG, "APN password=" + password);
