...
<!-- Generic page styles -->
<link rel="stylesheet" href="../jQuery-Upload/css/style.css">
...
<div class="container">
    ...
    <form id="fileupload" action="../Photo/addPhoto.do" method="POST" enctype="multipart/form-data" name="fileupload">
        ...
        <div class="row fileupload-buttonbar">
            ...
            <div class="row">
            <select multiple="multiple" class="tagingList" id="tagingList" name="atChildList">			
...
{% for (var i=0, file; file=o.files[i]; i++) { %}
    <tr class="template-upload fade">
		...
		<td class="title"><label>描述: <input name="title[]" required></label></td>
...
<script src="../jQuery-Upload/js/jquery.fileupload-fp.js"></script>
<!-- The File Upload user interface plugin -->
<script src="../jQuery-Upload/js/jquery.fileupload-ui.js"></script>
<!-- The localization script -->
<script src="../jQuery-Upload/js/locale.js"></script>
<!-- The main application script -->
<script src="../jQuery-Upload/js/main.js"></script>
<!-- The XDomainRequest Transport is included for cross-domain file deletion for IE8+ -->
<!--[if gte IE 8]><script src="../jQuery-Upload/js/cors/jquery.xdr-transport.js"></script><![endif]-->
