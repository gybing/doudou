package doudou.util.client;

import java.sql.SQLException;
import java.util.List;

import doudou.util.exception.DataAccessException;
import doudou.util.log.DouDouDBLog;
...
public class SimpleDatabaseClient implements DatabaseClient {
	...
	private DouDouDBLog log = new DouDouDBLog("SimpleDatabaseClient");
